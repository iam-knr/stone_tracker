    ...
    <div className="min-h-screen flex items-center justify-center bg-google-grey px-4">
      <div className="animate-fade-in bg-white rounded-2xl shadow-card p-8 w-full max-w-sm">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm text-gray-500 text-center mt-1">Enter your username and we'll email you a reset link, if your account has an email on file.</p>
        </div>

        {sent ? (
          <p className="text-sm text-gray-600 text-center">
            If an account with that username exists and has an email on file, a reset link has been sent. Check your inbox.
          </p>
        ) : (
